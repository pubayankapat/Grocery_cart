...
if(isset($_POST['update_product'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, category = ?, details = ?, price = ?, charge = ? WHERE id = ?");
   $update_product->execute([$name, $category, $details, $price,$charge,$pid]);
