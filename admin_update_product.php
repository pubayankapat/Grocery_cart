...
if(isset($_POST['update_product'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, category = ?, details = ?, price = ?, charge = ?, status= ? WHERE id = ?");
   $update_product->execute([$name, $category, $details, $price, $charge, $status, $pid]);
...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="charge" min="0" placeholder="enter delivery charge" required class="box" value="<?= $fetch_products['charge']; ?>">
      ...
      <input type="number" min="0" name="qty" class="box" required placeholder="enter total qty" value="<?= $fetch_products['Status']; ?>">
